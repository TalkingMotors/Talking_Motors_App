    ...
    if (item.param != [] && item.param.length > 0 && item.display==undefined) {
        return (
            <Transition >
                <Image
                    resizeMode='cover'
                    style={{ marginLeft: 0, borderRadius: 180, width: '100%', height: '100%', }}
        ...
        return (
            <Transition >
                <Image
                    resizeMode='cover'
                    style={{ marginLeft: 2, borderRadius: 180, width: '100%', height: '98%', }}
                    source={{ uri: item.param[0].url }}
                />
            </Transition>
        )
        ...
        return (
        <View style={{ width: '100%', height: '100%', borderRadius: 180, alignItems: 'center', justifyContent: 'center', backgroundColor: "#fff" }}>
