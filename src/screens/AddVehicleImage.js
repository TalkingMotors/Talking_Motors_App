...
export default class AddVehicleImage extends React.Component {
            ...
            <View style={styles.ParentView}>
                ...
                {this.state.base64Image != '' &&
                    <FontAwesome
                        ...
                        name="check" color={lightText} size={20} style={{ padding: 10, position: 'absolute', top: 10, right: 30, zIndex: 2 }}
                    />
                }
                {this.state.isloader &&
