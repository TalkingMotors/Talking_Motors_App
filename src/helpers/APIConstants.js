...
const APIService = {
    ...
    SEARCH_BY_REGISTRATION_NUMBER_ENDPOINT :    API_Path.BASE_URL + "search/registration-number/{vrm}",
    ...
    VEHICLE_DATA_ENDPOINT : API_Path.BASE_URL + "vehicle/vehicle-data/{vrm}",
    DVLA_VEHICLE_DATA_ENDPOINT :    API_Path.BASE_URL + "vehicle/all-dvla-data/{vrm}",
    DVLA_VEHICLE_AND_MOT_DATA_ENDPOINT :    API_Path.BASE_URL + "/vehicle/vehicle-and-mot-data/{vrm}",
    ...
    GET_VEHICLE_BY_VRM_ENDPOINT :   API_Path.BASE_URL + "vehicle/get-vehicle-by-vrm/{vrm}",
    ...
    GET_USER_VEHICLES_BY_USER_ID_ENDPOINT : API_Path.BASE_URL + "/vehicle/get-vehicles-by-user-id/{id}",
    GET_USER_BY_USER_ID_ENDPOINT :  API_Path.BASE_URL + "/users/{userId}",
    UPDATE_PROFILE_IMAGE_ENDPOINT : API_Path.BASE_URL + "/users/update-profile-image",
    GET_VEHICLE_BY_ID_ENDPOINT :    API_Path.BASE_URL + "/vehicle/{id}",
    ...
    GET_USER_BY_PHONE_NUMBER :  API_Path.BASE_URL + "/users/email/{telephone}",
}
